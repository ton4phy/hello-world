...
// A typical task is to make an automatic sending of a personal letter, where the user name is in the header.
...
// using the ready-made variables, and display the resulting lines on the screen.

// For the title, use the $ firstName and $ greeting variables, a comma and an exclamation point. 
...
// Perform the job using only two print_r.
